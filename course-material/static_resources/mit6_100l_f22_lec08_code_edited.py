...
#     lower_limit = int((n - epsilon)**2)
#     upper_limit = int((n + epsilon)**2) + 1
#     ans = 0 #initialize count of nums
#     # The range between lower_limit and upper_limit
#     # is where we will count the numbers 
