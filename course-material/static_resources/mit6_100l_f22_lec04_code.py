...
#     if i%2 == 0:
#         even_numbers += 1
# print(f'There are {even_numbers} even numbers in the provided range')
...
#     if i == 0:
#         unique_letters += s[i]
#         # print(unique_letters) # check if works as expected
#     else:
#         if s[i] not in unique_letters:
#             unique_letters += s[i]
#             # print(unique_letters) # check if works as expected
# print(f'There are {len(unique_letters)} in the string s provided.')
